...
<div class="container">
	...
	@endif
	<div class="container">
        <form class="needs-validation" action="/admin/success-stories/new" method="POST" novalidate>
		@csrf
		<div class="row">
		    <div class="col-md-8">
				<div class="container info-cont">
				    <div class="form-row">
						<div class="col-12 mb-3">
                            ...
                            <input  class="form-control" id="validationCustom02" name="heading" placeholder="e.g. Free Shipping"  value="{{old('content')}}">
                        </div>
					</div>
				</div>
			    <div class="container info-cont">
			...
			<div class="col-md-4">
				<div class="container info-cont">
				    <h3 class="info-cont-heading">Select Page</h3>
						<select class="form-select" id="validationCustom24" name="page">
                            <option value="home_page" >Home Page
                            </option>
                            <option value="health_page">Health Shots
                            </option>
                        </select>
				</div>
				<div class="container info-cont">
				    <h3 class="info-cont-heading">Select Section</h3>
						<select class="form-select" id="validationCustom24" name="section">
                            <option value="Main_page" >Main Page
                            </option>
