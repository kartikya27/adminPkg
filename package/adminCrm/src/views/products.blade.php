...
<div class="container">
	...
	<div class="container info-cont">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        	...
        	<li class="nav-item" role="presentation"> <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#active" role="tab" aria-controls="pills-profile" aria-selected="false">Active</a>
        	</li>
	            ...
	            <table class="table">
                	...
                	<tbody>
		        		...
		        		<tr class="table-row" data-href="/admin/products/{{$product['id']}}">
                			<th scope="row">
							    <div class="img-block mr-0" style="background-image:url('/storage/products/{{$product['id']}}/@php echo str_replace('.jpg','-360px.jpg',$product['product_pic1']) @endphp');"></div>
							</th>
							...
							@php
					            if($product->product_hasVariants == "Yes"){
					        		...
					        		$pprice = number_format($product->product_selling_price);
					        	}
					        @endphp
							<td class="align-middle">
							    INR {{$pprice}}
