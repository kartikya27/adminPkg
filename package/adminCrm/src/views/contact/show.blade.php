...
@section('style','.admin-menu.products i{color:#142437;}.admin-menu1.Contact{background-color:#eaeaea;border-left:5px solid #142437;color:#142437;}')
@section('content')
<div class="container">
	<div class="container p-0 mb-4">
	    <div class="row">
			...
			<div class="col-6 text-end">
			    <button class="btn btn-primary" onclick="window.location.href='/admin/Contact/new'">Add Section Content</button>
			</div>
           @endif 
		</div>
	</div>
        ...
        <div class="tab-content" id="pills-tabContent">
        	<div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="pills-home-tab">
	            <table class="table">
                	<thead>
                		<tr>
                			<th scope="col" width="">Phone - 1</th>
                			<th scope="col" width="">Phone - 2</th>
                			<th scope="col" width="">Email - 1</th>
                			<th scope="col" width="">Email - 2</th>
                	...
                	<tbody>
		        		...
		        		<tr class="table-row" data-href="/admin/Contact/{{$contact['id']}}">
