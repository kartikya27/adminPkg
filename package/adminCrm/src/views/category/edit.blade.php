	...
	<div class="container">
		...
		<div class="row">
		    <div class="col-md-8">
				...
				<div class="container info-cont">
				    <h3 class="info-cont-heading">Programs</h3>
					@if(count($products) > 0)
					    <table class="table">
					        <tbody>
					        ...
					        <tr>
                	    		<th scope="row">
					    		    <div class="img-block mr-0" style="background-image:url('/storage/home/programs/@php echo str_replace(' ','-',$product['program_code']) @endphp/@php echo str_replace('.jpg','-270px.jpg',$product['program_pic1']) @endphp');"></div>
					    		</th>
					...
					@else
						<p class="mb-0">No Active Program available</p>
					@endif
				</div>
			</div>
