...
<div class="container">
	    ...
	    <div class="row">
		    ...
		    <div class="col-md-9 p-0">
			    <table style="width:100%;height:100%"><tr><td class="align-middle" style="width:100%;height:100%">
				    <div class="heading2">Add Text Section Content</div>
				</td></tr></table>
			</div>
		</div>
	</div>
	...
	@endif
	<div class="container">
        <form class="needs-validation" action="/admin/who-we-are/new" method="POST" novalidate>
		@csrf
		<div class="row">
		    <div class="col-md-8">
				...
				<div class="container info-cont">
					...
					<div class="form-row">
					    <div class="col-12 mb-3">
							...
							<input type="text" class="form-control" id="validationCustom03" name="btnText" value="{{old('title')}}">
						</div>
					    <div class="col-12 mb-3">
						    <label for="validationCustom03">Link</label>
							<input type="text" class="form-control" id="validationCustom03" name="page_url" value="{{old('title')}}">
						</div>
					</div>
				</div>
