	...
	<div class="container p-0 mb-4">
	    <div class="row">
			...
			<div class="col-6 text-end">
			    <button class="btn btn-primary" onclick="window.location.href='/admin/testimonial/new'">Add Section Content</button>
			</div>
           @endif 
		</div>
	</div>
	            ...
	            <table class="table">
                	<thead>
                		<tr>
                			...
                			<th scope="col" width="">Post</th>
                			<th scope="col" width="">Status</th>
                		</tr>
                	</thead>
                	<tbody>
						
                		@foreach($data as $testimonialContent)
		        		<tr class="table-row" data-href="/admin/testimonial/{{$testimonialContent['id']}}">
                			...
                			<td class="align-middle">
							    <table class="table-borderless" style="width:100%;height:100%"><tr><td class="align-middle pl-0" style="width:100%;height:100%">
								{{$testimonialContent['post']}}    
								</td></tr></table>
							</td>
                			<td class="align-middle">
							    <table class="table-borderless" style="width:100%;height:100%"><tr><td class="align-middle pl-0" style="width:100%;height:100%">
								{{$testimonialContent['status']}}    
								</td></tr></table>
							</td>
