...
@section('app_name','Orders View')
@section('style','.admin-menu.orders i{color:#142437;}.admin-menu1.orders{background-color:#eaeaea;border-left:5px solid #142437;color:#142437;}')
@section('content')
<div class="container">
    <h1 class="heading1">Orders</h1>
	<div class="container info-cont">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        	<li class="nav-item" role="presentation"> <a class="nav-link active" id="pills-all-tab" data-bs-toggle="pill" href="#all" role="tab" aria-controls="pills-all" aria-selected="true">All</a>
        	</li>
        	<li class="nav-item" role="presentation"> <a class="nav-link" id="pills-open-tab" data-bs-toggle="pill" href="#open" role="tab" aria-controls="pills-open" aria-selected="false">Open</a>
        	</li>
        	<li class="nav-item" role="presentation"> <a class="nav-link" id="pills-closed-tab" data-bs-toggle="pill" href="#closed" role="tab" aria-controls="pills-closed" aria-selected="false">Closed</a>
        	</li>
        	<li class="nav-item" role="presentation"> <a class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" href="#cancelled" role="tab" aria-controls="pills-contact" aria-selected="false">Cancelled</a>
        	</li>
        </ul>
...
<script>
	var ordersCollapse = document.getElementById('ordersCollapse');
	var bsCollapse = new bootstrap.Collapse(ordersCollapse, {
		toggle: false,
		show: true, //useless
		hide: false, //useless
	});
