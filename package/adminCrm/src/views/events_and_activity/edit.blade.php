                ...
                <div class="col-md-8">
					...
					<div class="form-row row">
						<div class="col-6 mb-3">
							...
							<input type="text" class="form-control" id="validationCustom03" name="goal_amt" value="{{old('goal_amt',$event['goal_amt'])}}" >
						</div>
						<div class="col-6 mb-3">
							<label for="validationCustom03">Funded Amount</label>
							<input type="text" class="form-control" id="validationCustom03" name="funded_amt" value="{{old('funded_amt',$event['funded_amt'])}}" >
						</div>
					</div>
