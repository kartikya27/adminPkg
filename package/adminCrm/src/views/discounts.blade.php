...
@section('style','.admin-menu.discounts{background-color:#eaeaea;border-left:5px solid #142437;color:#142437;}')
@section('content')
<div class="container">
    <div class="container p-0 mb-4">
	    <div class="row">
			...
			<div class="col-6 text-end">
				<div class="btn-group">
                	<button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Create discount </button>
	...
	<div class="container info-cont">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        	<li class="nav-item" role="presentation"> <a class="nav-link active" id="pills-discount-tab" data-bs-toggle="pill" href="#discount" role="tab" aria-controls="pills-discount" aria-selected="true">Discount codes</a></li>
        	<li class="nav-item" role="presentation"> <a class="nav-link" id="pills-automatic-tab" data-bs-toggle="pill" href="#automatic" role="tab" aria-controls="pills-automatic" aria-selected="false">Automatic discounts</a></li>
        </ul>
	                ...
	                <table class="table">
                    	...
                    	<tbody>
                    		@foreach($discountCodes as $discount)
				    		    <tr class="table-row" data-bs-href="/admin/discounts/code/{{$discount['id']}}">
				    			    <th scope="row">
	                ...
	                <table class="table">
                    	...
                    	<tbody>
                    		@foreach($automaticDiscounts as $discount)
				    		    <tr class="table-row" data-bs-href="/admin/discounts/automatic/{{$discount['id']}}">
				    			    <th scope="row">
